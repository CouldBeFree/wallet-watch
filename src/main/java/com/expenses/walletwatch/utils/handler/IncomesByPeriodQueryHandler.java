...
public class IncomesByPeriodQueryHandler {
    public static final String GET_INCOMES_BY_PERIOD = """
                SELECT SUM(amount), user_transaction_incomes.income_category_id, incomes_category.incomes_category_name, incomes_category.color
                ...
                GROUP BY incomes_category.incomes_category_name, user_transaction_incomes.income_category_id, incomes_category.color
                """;
}
